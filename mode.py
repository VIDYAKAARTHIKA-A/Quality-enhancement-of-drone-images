...
def train(args):
    ...
    if args.fine_tuning:
        ...
        print(f"Path: {args.generator_path}")
    ...
    while pre_epoch < args.pre_train_epoch:
        ...
        if pre_epoch % 10 == 0:
            torch.save(generator.state_dict(), f'./model/pre_trained_model_{pre_epoch:03d}.pt')
    ...
    while fine_epoch < args.fine_train_epoch:
        ...
        for i, tr_data in enumerate(loader):
            ...
            if real_prob.shape != real_label.shape:
            ...
            total_variance_loss = args.tv_loss_coeff * tv_loss((hr_feat - sr_feat)**2)
...
def test(args):
    ...
    with torch.no_grad():
        for i, te_data in enumerate(loader):
            ...
            result.save(f'./result/res_{i:04d}.jpg')
